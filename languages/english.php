...
$LNG['user_exists'] = 'Ce nom existe déjà';
$LNG['email_exists'] = 'Adresse mail déjà utilisée.';
$LNG['all_fields'] = 'Tous les champs doivent être remplis !';
$LNG['user_alnum'] = 'Le nom doit contenir uniquement du texte et des lettres';
$LNG['user_too_short'] = 'Le nom doit comporter entre 3 et 32 caractères';
$LNG['user_limit'] = 'Trop de comptes créer via cette IP';
$LNG['invalid_email'] = 'E-mail invalide !';
$LNG['invalid_user_pw'] = 'Nom ou mot de passe invalide !';
$LNG['invalid_captcha'] = 'Invalid captcha';
$LNG['log_out'] = 'Se déconnecter';
$LNG['hello'] = 'Yo ';
$LNG['connect'] = 'Se connecter';
$LNG['register'] = 'Enregistrement';
$LNG['login'] = 'Login';
$LNG['password'] = 'Password';
$LNG['username'] = 'Username';
$LNG['email'] = 'Email';
$LNG['captcha'] = 'Captcha';
$LNG['username_or_email'] = 'Username ou mot de passe';
$LNG['welcome_desc'] = 'Pas de "Pouet Pouet", pas de fanfare !';
$LNG['join_now'] = 'Ecoutez et partagez ! RAVE ON !';
$LNG['learn_more'] = 'En savoir plus';
$LNG['creators'] = 'Du stream de son de teuf , et que du bon son !';
$LNG['listeners'] = 'Ecoutez';
$LNG['audience'] = 'Partagez';
$LNG['organize'] = 'Organisez';
$LNG['featured'] = 'Featured';
$LNG['popular'] = 'Popular';
$LNG['_desc'] = 'Un site de streaming uniquement consacré au son 2 teuf';
$LNG['audience_desc'] = 'No "pouet-pouet"';
$LNG['statistics_desc'] = 'No fanfare !';
$LNG['explore_desc'] = 'Ecoutez du son déjà trié !';
$LNG['share_desc'] = 'Partagez le son qui vous fait vibrer';
$LNG['organize_desc'] = 'Créez des playlist comme bon vous semble !';
$LNG['forgot_password'] = 'Mot de passe oublié';
$LNG['all_rights_reserved'] = 'Tous droits réservés';

// NOTIFICATION BOXES //
$LNG['settings_saved'] = 'Paramètres sauvegardés';
$LNG['password_changed'] = 'Mot de passe changé';
$LNG['nothing_changed'] = 'Rien n a changé';
$LNG['password_not_changed'] = 'Mot de passe non changé';
$LNG['image_saved'] = 'Image sauvegardée';
$LNG['profile_picture_saved'] = 'Votre photo de profil a été changée.';
$LNG['error'] = 'Error';
$LNG['no_file'] = 'Vous avez pas sélectionné tous de fichier à télécharger , ou le fichier sélectionné est vides.';
...
$LNG['profile_picture_removed'] = 'Votre photo de profil a bien été éffacée';
...
$LNG['playlist_name_empty'] = 'La playlist ne peut pas être vide';
$LNG['changes_saved'] = 'Changements sauvegardés';
$LNG['valid_email'] = 'Email non valide';
$LNG['valid_url'] = 'Entrer une url valide';
$LNG['valid_country'] = 'Mettre un pays valide';
$LNG['background_changed'] = 'Photo de couverture changée';
$LNG['background_not_changed'] = 'La photo de couverture non changée';
$LNG['password_too_short'] = 'The password must contain at least <strong>3</strong> characters.';
$LNG['username_not_found'] = 'Nous ne pouvons trouver le nom d\'utilisateur';
...
$LNG['email_footer_gen'] = '<br /><br /><span style="color: #aaa;">Copyright &copy; '.date('Y').' <a href="%s">%s</a>. Tous droits réservés';
$LNG['email_hello'] = 'Yo  <strong>%s</strong>,<br /><br />';
$LNG['user_created'] = 'Merci de nous rejoindre <strong>%s</strong><br /><br />Votre nom utilisateur: <strong>%s</strong><br />Votre mot de passe: <strong>%s</strong><br /><br />You can log-in at: <a href="%s" target="_blank">%s</a>'.$LNG['email_footer_gen'];
...
// STREAM //
$LNG['welcome_stream_ttl'] = 'Bienvenue sur votre page de stream';
$LNG['welcome_stream'] = 'Tous vos son ainsi que ceux de vos amis apparaissent ici';
$LNG['leave_comment'] = 'Mettre un commentaire...';
$LNG['post'] = 'Post';
$LNG['view_more_comments'] = 'Voire plus de commentaires';
...
$LNG['delete_this_comment'] = 'Effacer ce commentaire';
